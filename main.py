class Snake:
    ...
    def simple_move(self):
        ...
        '''Удаление хвоста, если длина позиций больше self.snake_body'''
    ...
    def eat(self, food_type):
        ...
        if food_type == 'apple': self.snake_body = self.snake_body + 1 ''''''
        if food_type == 'pear': self.snake_body = self.snake_body - 1 ''''''
        if food_type == 'grape': '''Активация ускорение для змеи'''

        '''Возвращение эффекта для вижуала.'''
